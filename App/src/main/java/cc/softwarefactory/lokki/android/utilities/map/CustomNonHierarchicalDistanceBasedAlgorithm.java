...
/**
 * Created by haider on 19.11.2015.
 * Adds remove item to NonHierarchicalDistanceBasedAlgorithm
 */
public class CustomNonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
